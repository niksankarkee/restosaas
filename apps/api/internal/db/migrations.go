...
func runCustomMigrations(db *gorm.DB) error {
	migrations := []struct {
		...
		},
		{
			...
			query:       `ALTER TABLE org_members ADD CONSTRAINT IF NOT EXISTS fk_org_members_user FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE`,
		...
		},
		{
			...
			query:       `ALTER TABLE org_members ADD CONSTRAINT IF NOT EXISTS fk_organizations_users FOREIGN KEY (org_id) REFERENCES organizations(id) ON DELETE CASCADE`,
		...
		},
		{
			...
			query:       `ALTER TABLE restaurants ADD CONSTRAINT IF NOT EXISTS fk_organizations_restaurant FOREIGN KEY (org_id) REFERENCES organizations(id) ON DELETE CASCADE`,
		...
		},
		{
			...
			query:       `ALTER TABLE images ADD CONSTRAINT IF NOT EXISTS fk_restaurants_images FOREIGN KEY (restaurant_id) REFERENCES restaurants(id) ON DELETE CASCADE`,
		...
		},
		{
			...
			query:       `ALTER TABLE opening_hours ADD CONSTRAINT IF NOT EXISTS fk_restaurants_open_hours FOREIGN KEY (restaurant_id) REFERENCES restaurants(id) ON DELETE CASCADE`,
